...
public class HttpUtils {
    ...
    public static String doPost(String apiUrl, List<BasicNameValuePair> pairList) {
        return doPostHttp(apiUrl, pairList, null);
    }
     ...
     * @return
     */
    public static String doPostHttp(String apiUrl, List<BasicNameValuePair> pairList, Map<String, String> headers) {
