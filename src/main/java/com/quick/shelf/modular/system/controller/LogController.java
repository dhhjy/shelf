...
import com.quick.shelf.core.common.constant.state.BizLogType;
import com.quick.shelf.core.common.page.LayuiPageFactory;
import com.quick.shelf.modular.system.entity.OperationLog;
import com.quick.shelf.modular.system.service.OperationLogService;
import com.quick.shelf.modular.system.warpper.LogWrapper;
...
public class LogController extends BaseController {
    ...
    public String detail(@PathVariable Long id, Model model) {
        ...
        model.addAttribute("log", operationLog.getMessage());
