package com.quick.shelf.modular.creditPort.quickMoney.bill99;
...
import com.quick.shelf.modular.creditPort.quickMoney.bill99.util.Base64Binrary;
import com.quick.shelf.modular.creditPort.quickMoney.bill99.util.MyX509TrustManager;
import com.quick.shelf.modular.creditPort.quickMoney.bill99.util.ParseUtil;
...
public class Post
{
    ...
    public static HashMap sendPost(String url, String tr1XML, TransInfo transInfo) throws Exception
    {
        ...
        //获取证书路径
        File certFile = new File(QuickMoneyConstartMethod.JKS_FILE);  //测试证书，生产环境需要替换
        ...
        try
        {
            ...
            //发送请求参数
            out.write(tr1XML.getBytes(StandardCharsets.UTF_8));
            ...
            if(is!=null && !"".equals(is))
            {
                ...
                reqData = new String(bos.toByteArray(), StandardCharsets.UTF_8);//编码后的tr2报文
            }
    ...
    public static void main(String[] args) {
        File certFile1 = new File("D://TS/mgw.cer");
